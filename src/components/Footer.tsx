...
const Footer = () => {
  return (
    <footer className="text-charcoal-500">
      <div className="container mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 bg-mist-500 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div>
            ...
            <ul className="flex text-2xl md:text-4xl text-olive-400 gap-4 transition-all duration-150 ease-in-and-out">
              <li>
        ...
        <div className="w-full text-md text-center text-charcoal-500 mt-4">
          <div className="border border-charcoal-300"></div>
